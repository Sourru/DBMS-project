      ...
      <table class="table table-bordered">
       <thead>
        <tr style="font-size: 14.3px;">
          <th><a href="comp_sort.php?ID=<?php echo urlencode($id)?>&column=ID&order=<?php echo $asc_or_desc; ?>&sql=<?php echo urlencode($sql) ?>&sql1=<?php echo urlencode($sql1) ?>&flag=<?php echo urlencode($flag) ?>">Reg. ID<i class="fas fa-sort<?php echo $column == 'ID' ? '-' . $up_or_down : ''; ?>"></i></a></th>
